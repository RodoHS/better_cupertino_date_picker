...
import 'cust_button_widget.dart';
...
/// Different display modes of [BetterCupertinoDatePicker].
///
/// See also:
///
///  * [BetterCupertinoDatePicker], the class that implements different display modes
...
enum CupertinoDatePickerMode {
  ...
  /// The AM/PM designation is shown only if [BetterCupertinoDatePicker] does not use 24h format.
...
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
class BetterCupertinoDatePicker extends StatefulWidget {
...
class _CupertinoDatePickerDateTimeState extends State<BetterCupertinoDatePicker> {
  ...
  @override
  void didUpdateWidget(BetterCupertinoDatePicker oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] =
          BetterCupertinoDatePicker._getColumnWidth(columnType, localizations, context);
    }
...
class _CupertinoDatePickerDateState extends State<BetterCupertinoDatePicker> {
  late int textDirectionFactor;
  late CupertinoLocalizations localizations;
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.dayOfMonth.index] = BetterCupertinoDatePicker._getColumnWidth(_PickerColumnType.dayOfMonth, localizations, context);
    estimatedColumnWidths[_PickerColumnType.month.index] = BetterCupertinoDatePicker._getColumnWidth(_PickerColumnType.month, localizations, context);
    estimatedColumnWidths[_PickerColumnType.year.index] = BetterCupertinoDatePicker._getColumnWidth(_PickerColumnType.year, localizations, context);
  }
